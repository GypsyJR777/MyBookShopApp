                ...
                init: function () {
                    ...
                    $entryButton.on('click', function (e) {
                        ...
                        if ($this.is('[data-send]')) {
                            ...
                            if (!error  && $this.attr('id') == 'toComeInMail') {
            ...
            return {
                init: function () {
                    ...
                    $btnSend.on('click', function (e) {
                        ...
                        } else if ($this.data('sendstatus') === 'REVIEW'){
                            Login().postData('/books/' + $this.data('bookid'), {
                                booksIds: $this.data('bookid'),
                    ...
                    $ProductAssesment.find('.Rating input').on('change', function (e) {
                        ...
                        Login().postData('/books/rateBook', {
                            ...
                            bookSlug: $this.closest('.Rating').data('bookslug'),
                                    ...
                                    if ($(slick.$slider).data('load')) {
                                        ...
                                        switch ($(slick.$slider).data('load')) {
                                            ...
                                            case'popular':
                                                ...
                                                break;
                                            case'author':
                                                sendData('/authors/page/' + $(slick.$slider).data('refreshid'));
                                                break;
                                        }
                                    }
                                }
